  ...
  <div class="mb-32 text-gray-800 text-center lg:text-left">
    ...
    <div class="md:px-6 py-12 md:px-12">
      <div class="max-w-4xl container mx-auto ">
        <div class="grid lg:grid-cols-2 flex items-end">
          ...
          <img class="w-full rounded-lg shadow-lg object-center" src="assets/portrait.svg" alt="vector art silhoutte of my head in profile"/>
          </div>
        </div>
      </div>
    </div>
